<?php
/**
 * Medyc Elementor Global Widget Blog_Block.
 *
...
class Medyc_Elementor_Global_Widgets_Blog_Block extends Widget_Base {

	/**
	 * Retrieve Medyc_Elementor_Global_Widgets_Blog_Block widget name.
	 *
	 * @access public
	 *
	...
	public function get_name() {
		return 'Medyc-Global-Widgets-Blog-Block';
	}

	/**
	 * Retrieve Medyc_Elementor_Global_Widgets_Blog_Block widget Title.
	 *
	 * @access public
	 *
	...
	public function get_title() {
		return esc_html__( 'Blog Block', 'medyc' );
	}

	/**
	 * Retrieve medyc_Elementor_Global_Widget_Blog_Block widget icon.
	 *
	 * @access public
	 *
	...
	/**
	 * Retrieve the list of categories the medyc_Elementor_Global_Widget_Blog_Block widget belongs to.
	 *
	...
	/**
	 * Register medyc_Elementor_Global_Widget_Blog_Block widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_Blog_block_title_manage',
			array(
				'label' => esc_html__( 'Blog Block', 'medyc' ),
			)
		);
	...
	/**
	 * Render Medyc_Elementor_Global_Widgets_Blog_Block widget output on the frontend.
	 *
	...
	protected function render() {
      ...
      <div class="flex-container w-container">
          <div class="main-title"><h2 class="main-title-heading"><?php echo esc_html($about_title); ?></h2></div>
						...
						if ($query->have_posts()) {
						    while ($query->have_posts()) {
								...
								<div role="listitem" class="blog-item w-dyn-item w-col w-col-4">
			                      <div class="inner-blog-item w-clearfix">
